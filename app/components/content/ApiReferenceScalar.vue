...
<style>
  .scalar-app {
    ...
    .dark-mode {
      ...
      --scalar-background-3: hsl(var(--secondary));
      ...
      --scalar-button-1: hsl(var(--background));
      --scalar-button-1-hover: hsl(var(--background) / 0.8);
      --scalar-button-1-color: hsl(var(--foreground));
